	...
	function init() {
		...
		$books.each( function() {
			...
			var $book = $( this ),
				...
				$bookview = $parent.find( 'a.bk-bookview' ),
				$bookcover = $book.find('div.bk-cover'),
			...
			$bookview.on( 'click', function() {
				...
				$other.data( 'opened', false ).removeClass( 'bk-viewinside' ).parent().css( 'z-index', 0 ).find( 'a.bk-bookview' ).removeClass( 'bk-active' );
