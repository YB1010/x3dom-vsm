		...
		<article id="container">
			...
			<section>
                ...
                <?php
                    ...
                    echo "<a href=\"view_order.php\">All user</a> |";
                    
                    while ($rows = mysql_fetch_array($result)) {
                        echo "<a href=\"view_order.php?OrderStatusID=" . $rows["OrderStatusID"] . "\">";
                    ...
                    $result = selectOrder("", $_REQUEST["OrderStatusID"]);
				...
				<div class="itemcontainer">
                    <ul>
						<li><p>Your system have no user yet.</p></li>
					</ul>
                </div>
                ...
                <?php
                        ...
                        while ($rows = mysql_fetch_array($result)) {
                            echo "<a href=\"view_order_list.php?AccountID=" . $rows["AccountID"] . "\" >";
							echo "<li><p>Fullname: " . $rows["AccountName"] . "</p>";
							echo "<p>AccountName (Email): " . $rows["AccountEmail"] . "</p>";
							echo "<p>Quantity: " . $rows["amount"] . "</p>";
                            echo "</li></a>";
                        }
