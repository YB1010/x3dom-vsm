		...
		<article id="container">
			...
			<section>
				...
				<div class="product_detail">
					<img src="../image_uploads/<?=$getProductResult["ProductImage"];?>" />
					
					<div class="product_detail_panel">
						<p>Name: <?=$getProductResult["ProductName"];?></p>
						<p>Detail: <?=$getProductResult["ProductText"];?></p>
						<p>Price: <?=$getProductResult["ProductPrice"];?> Thai Baht</p>
					</div>

					<iframe class="product_detail_visual_panel" 
						frameborder="0"
						src="../3d_uploads/<?=$getProductResult["Product3DFile"];?>"
						scrolling="no"
					...
					<div class="config_panel">
						<ul>
							<a href="../functions/user_purchase_func.php?ProductID=<?=$getProductResult["ProductID"];?>"><li style="background: #22C6B5;">Purchase</li></a>
