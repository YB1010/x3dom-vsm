...
<div class="row-fluid">
	...
	<div class="span5">
		...
		<div class="caption">
			...
			<a href="#" class="btn btn-block btn-primary" data-loading-text="กำลังโหลดข้อมูล..." proc="addtocart" data-pid="<?php echo $rows['ProductID']; ?>" data-name="<?php echo $rows['ProductName']; ?>" data-author="<?php echo $rows['Author']; ?>" data-price="<?php echo $rows['Price']; ?>" data-discount="<?php echo $rows['Discount']; ?>">หยิบลงตะกร้า</a>
		</div>
	</div>
</div>
